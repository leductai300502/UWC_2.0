...
<body>
    ...
    <main class="flex flex-row w-full bg-white text-blck">
        <div class="flex flex-col w-1/5 bg-zinc-300">
            ...
            <div class="flex items-center border-r-4 text-zinc-500 border-r-4 border-black p-2 h-24">
            ...
            <div class="flex flex-row items-center border-r-4 border-zinc-300 hover:text-zinc-500 hover:border-black p-2 h-24">
        ...
        <div class="flex flex-col w-4/5 p-2 trang_chu">
            <div class="p-8 text-3xl font-bold">Trang Chủ</div>
            <div class="grid grid-cols-3 gap-4 h-48 p-4">
                <div class="bg-zinc-300 rounded-lg p-4"></div>
                <div class="bg-zinc-300 rounded-lg p-4"></div>
                <div class="bg-zinc-300 rounded-lg p-4"></div>
            </div>
            <div class="flex p-4 h-full">
                <div class="flex w-full h-full bg-zinc-300 rounded-lg p-4"></div>
            </div>
        </div>
    </main>
