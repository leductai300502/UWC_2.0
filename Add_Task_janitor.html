...
<body>
    ...
    <div class="absolute w-3/4 opacity-100 z-10 top-48 left-52 bg-gray-100 border-zinc-300 border-2 shadow-2xl rounded-xl shadow-znic-900 p-4">
        <div class="flex flex-col p-2">
            <div class="flex flex-col p-2">
                <div class="flex flex-row justify-between p-2">
                    <div class="text-4xl font-bold">Tạo công việc mới</div>
                    <div class="p-2">
                ...
                <div class="text-2xl font-bold p-2 text-green-700 font-bold">Janitor</div>
            </div>
            <div class="flex flex-row">
                ...
                <div class=" flex w-1/2 h-full p-2">
                    <form name="myForm" class="w-full p-2" onsubmit="return false;">
                        ...
                        <div class="flex w-full justify-center p-2">   
                            <button type="submit" onclick="validateForm()" class="flex transition ease-in-out delay-150 bg-zinc-500 hover:-translate-y-1 hover:scale-110 hover:bg-zinc-300 duration-300 border-2 border-black rounded-lg px-4 py-2">Tạo Mới</button>                   
                        </div>
                    </form>
                </div>
            </div>
