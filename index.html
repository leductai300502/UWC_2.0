...
<head>
    ...
    <link rel="stylesheet" href="style_image_hidden.css">
    <title>Home Page</title>
</head>

<body>
    <header class="w-full bg-white  px-8 py-4 text-black font-bold environment">
        <div class="flex flex-row gap-x-5 p-8">
            <div class="basis-1/4 flex-none p-2">
                <div class="flex justify-start items-center p-2">
                    UWC 2.0
                </div>
            </div>
            <div class="basis-1/2 flex-none hidden md:block cover rounded-3xl shadow-2xl shadow-white">
                <div class="flex h-16 flex-row gap-x-8 justify-center items-center font-bold p-2">
                    <a href="#" class="p-2 text-shadow text_decorate hover_text">Home</a>
                    <a href="#" class="p-2 text-shadow text_decorate hover_text">Stories</a>
                    <a href="#" class="p-2 text-shadow text_decorate hover_text">System</a>
                    <a href="#" class="p-2 text-shadow text_decorate hover_text">News</a>
                </div>
            </div>
            <div class="basis-1/4 flex justify-end items-center">
                <div class="flex rounded-full cover shadow-2xl shadow-white">
                    <a href="login.html" class="flex justify-center p-2 text-shadow text_decorate hover_text">Login</a>
                </div>
            </div>
        </div>
        <!-- <div class="flex flex-row gap-x-5 justify-center p-2">
            <div class="flex justify-center p-8">
                <h1 class="flex w-1/3 text-6xl font-bold text-center items-center">
                    UWC 2.0
                </h1>
            </div>
        </div> -->
    </header>
    <!-- <main class="flex flex-col w-full bg-gray-300 p-4">
            ...
            <div class="flex flex-col">
                <div class="grid grid-cols-3 gap-4 max-sm:grid-cols-1">
                    ...
                    <div class="flex list_item">
                        <div class="grow">
                            <a href="#" class="text-white p-2"><i class="fa-brands fa-instagram text-3xl menu_hover"></i></a>
                        </div>
                        <div class="grow">
                            <a href="#" class="text-white p-2"><i class="fa-brands fa-square-twitter text-3xl menu_hover"></i></a>
                        </div>
                        <div class="grow">
                            <a href="#" class="text-white p-2"><i class="fa-brands fa-youtube text-3xl menu_hover"></i></a>
                        </div>
                        <div class="grow">
                            <a href="#" class="text-white p-2"><i class="fa-brands fa-facebook text-3xl menu_hover"></i></a>
                        </div>
                    </div>
                </div>
