...
<body>
    ...
    <main class="flex flex-row w-full bg-white text-blck">
        <div class="flex flex-col w-1/5 bg-zinc-300">
            ...
            <div class="flex items-center border-r-4 border-zinc-300 hover:text-zinc-500 hover:border-black p-2 h-24">
            ...
            <div class="flex flex-row items-center border-r-4 p-2 h-24 border-zinc-300 hover:text-zinc-500 hover:border-black">
        ...
        <div class="flex flex-col w-4/5 gap-y-8 p-2 trang_chu">
            <div class="p-8 text-3xl font-bold">Điểm Thu Thập</div>
            <div class="p-8 text-2xl font-bold">MCP 1</div>
            <div class="grid grid-cols-3 gap-4 p-4">
                <div class="flex flex-col bg-zinc-300 rounded-lg p-4">
                    <div class="flex justify-center text-2xl font-bold p-2 items-center">Vị Trí MCP 1</div>
                    <div class="flex flex-row justify-center items-center p-2">
                        <div class="flex flex-row justify-center p-2">
                            <div class="flex text-5xl font-bold justify-center p-1">---</div>
                            <div class="flex text-2xl items-center justify-center p-1">$$$</div>
                        </div>
                ...
                <div class="flex flex-col bg-zinc-300 rounded-lg p-4">
                    <div class="flex justify-center text-2xl font-bold p-2 items-center">Nhân Viên Thực Hiện</div>
                    <div class="flex flex-row justify-center items-center p-2">
                        <div class="flex flex-row justify-center p-2">
                            <div class="flex text-5xl font-bold justify-center p-1">---</div>
                            <div class="flex text-2xl items-center justify-center p-1">$$$</div>
            ...
            <div class="flex p-4 h-full">
                <div class="flex flex-col w-full h-full bg-zinc-300 rounded-lg p-4">
                    <div class="flex flex-row p-2 gap-x-4 items-center">
                        <div class="text-4xl font-bold p-2 w-3/6">Danh Sách MCP</div>
                        ...
                        <!-- <div class="flex justify-between items-center w-1/6 h-3/4 bg-gray-500 rounded-lg p-2 overflow-hidden">
                            <div class="fex flex-col"> 
                                <div class="flex p-2 text-xl Janitor">Xe</div>
                                <div class="flex p-2 text-xl hidden Collector">Xe Đẩy</div>
                            </div>
